...
// stubs/Stub_Skeleton_input_Detections_boundingBox.h
...
#ifndef Stub_Skeleton_input_Detections_boundingBox_def
#define Stub_Skeleton_input_Detections_boundingBox_def
...
/**
 * stub class for: Class_Skeleton_input_Detections_boundingBox
 * 
 * module: Skeleton Module
 * description: bounding box
 */
class Stub_Skeleton_input_Detections_boundingBox {

public:
	Stub_Skeleton_input_Detections_boundingBox();
	Stub_Skeleton_input_Detections_boundingBox(const Stub_Skeleton_input_Detections_boundingBox& other);
	Stub_Skeleton_input_Detections_boundingBox(const rapidjson::Value& value);
	Stub_Skeleton_input_Detections_boundingBox(const std::string& str);
	virtual ~Stub_Skeleton_input_Detections_boundingBox();
	Stub_Skeleton_input_Detections_boundingBox &operator =(const Stub_Skeleton_input_Detections_boundingBox& other);
	Stub_Skeleton_input_Detections_boundingBox &operator =(Stub_Skeleton_input_Detections_boundingBox&& other) noexcept;
...
#endif // Stub_Skeleton_input_Detections_boundingBox_def