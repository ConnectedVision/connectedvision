...
// stubs/Stub_generic_moduleStatus.h
...
#ifndef Stub_generic_moduleStatus_def
#define Stub_generic_moduleStatus_def

// --> Do NOT EDIT <--
namespace ConnectedVision {

/**
 * stub class for: Class_generic_moduleStatus
 * 
 * module: 
 * description: Module Status Schema
 */
class Stub_generic_moduleStatus {

public:
	Stub_generic_moduleStatus();
	Stub_generic_moduleStatus(const Stub_generic_moduleStatus& other);
	Stub_generic_moduleStatus(const rapidjson::Value& value);
	Stub_generic_moduleStatus(const std::string& str);
	virtual ~Stub_generic_moduleStatus();
	Stub_generic_moduleStatus &operator =(const Stub_generic_moduleStatus& other);
	Stub_generic_moduleStatus &operator =(Stub_generic_moduleStatus&& other) noexcept;
...
public:
	...
	virtual bool is_moduleStatus_na() const { return is_moduleStatus( Stub_generic_moduleStatus::moduleStatus_na ); }
	virtual void set_moduleStatus_na() { set_moduleStatus ( Stub_generic_moduleStatus::moduleStatus_na ); }
	const static boost::shared_ptr<std::string> moduleStatus_up;
	virtual bool is_moduleStatus_up() const { return is_moduleStatus( Stub_generic_moduleStatus::moduleStatus_up ); }
	virtual void set_moduleStatus_up() { set_moduleStatus ( Stub_generic_moduleStatus::moduleStatus_up ); }
	const static boost::shared_ptr<std::string> moduleStatus_down;
	virtual bool is_moduleStatus_down() const { return is_moduleStatus( Stub_generic_moduleStatus::moduleStatus_down ); }
	virtual void set_moduleStatus_down() { set_moduleStatus ( Stub_generic_moduleStatus::moduleStatus_down ); }
...
#endif // Stub_generic_moduleStatus_def