...
// stubs/Stub_DummyBoundingBoxes_params_boundingBoxEnd.h
...
#ifndef Stub_DummyBoundingBoxes_params_boundingBoxEnd_def
#define Stub_DummyBoundingBoxes_params_boundingBoxEnd_def
...
/**
 * stub class for: Class_DummyBoundingBoxes_params_boundingBoxEnd
 * 
 * module: DummyBoundingBoxes
 * description: last bounding box data at end of video
 */
class Stub_DummyBoundingBoxes_params_boundingBoxEnd {

public:
	Stub_DummyBoundingBoxes_params_boundingBoxEnd();
	Stub_DummyBoundingBoxes_params_boundingBoxEnd(const Stub_DummyBoundingBoxes_params_boundingBoxEnd& other);
	Stub_DummyBoundingBoxes_params_boundingBoxEnd(const rapidjson::Value& value);
	Stub_DummyBoundingBoxes_params_boundingBoxEnd(const std::string& str);
	virtual ~Stub_DummyBoundingBoxes_params_boundingBoxEnd();
	Stub_DummyBoundingBoxes_params_boundingBoxEnd &operator =(const Stub_DummyBoundingBoxes_params_boundingBoxEnd& other);
	Stub_DummyBoundingBoxes_params_boundingBoxEnd &operator =(Stub_DummyBoundingBoxes_params_boundingBoxEnd&& other) noexcept;
...
#endif // Stub_DummyBoundingBoxes_params_boundingBoxEnd_def