...
// stubs/Stub_DummyBoundingBoxes_output_ObjectData_detections_boundingBox.h
...
#ifndef Stub_DummyBoundingBoxes_output_ObjectData_detections_boundingBox_def
#define Stub_DummyBoundingBoxes_output_ObjectData_detections_boundingBox_def
...
/**
 * stub class for: Class_DummyBoundingBoxes_output_ObjectData_detections_boundingBox
 * 
 * module: DummyBoundingBoxes
 * description: bounding box
 */
class Stub_DummyBoundingBoxes_output_ObjectData_detections_boundingBox {

public:
	Stub_DummyBoundingBoxes_output_ObjectData_detections_boundingBox();
	Stub_DummyBoundingBoxes_output_ObjectData_detections_boundingBox(const Stub_DummyBoundingBoxes_output_ObjectData_detections_boundingBox& other);
	Stub_DummyBoundingBoxes_output_ObjectData_detections_boundingBox(const rapidjson::Value& value);
	Stub_DummyBoundingBoxes_output_ObjectData_detections_boundingBox(const std::string& str);
	virtual ~Stub_DummyBoundingBoxes_output_ObjectData_detections_boundingBox();
	Stub_DummyBoundingBoxes_output_ObjectData_detections_boundingBox &operator =(const Stub_DummyBoundingBoxes_output_ObjectData_detections_boundingBox& other);
	Stub_DummyBoundingBoxes_output_ObjectData_detections_boundingBox &operator =(Stub_DummyBoundingBoxes_output_ObjectData_detections_boundingBox&& other) noexcept;
...
#endif // Stub_DummyBoundingBoxes_output_ObjectData_detections_boundingBox_def