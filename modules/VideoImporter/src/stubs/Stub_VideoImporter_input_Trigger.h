...
// stubs/Stub_VideoImporter_input_Trigger.h
...
#ifndef Stub_VideoImporter_input_Trigger_def
#define Stub_VideoImporter_input_Trigger_def
...
/**
 * stub class for: Class_VideoImporter_input_Trigger
 * 
 * module: VideoImporter
 * description: Trigger pulse used as signal for the generation of a bounding box.
 */
class Stub_VideoImporter_input_Trigger {

public:
	Stub_VideoImporter_input_Trigger();
	Stub_VideoImporter_input_Trigger(const Stub_VideoImporter_input_Trigger& other);
	Stub_VideoImporter_input_Trigger(const rapidjson::Value& value);
	Stub_VideoImporter_input_Trigger(const std::string& str);
	virtual ~Stub_VideoImporter_input_Trigger();
	Stub_VideoImporter_input_Trigger &operator =(const Stub_VideoImporter_input_Trigger& other);
	Stub_VideoImporter_input_Trigger &operator =(Stub_VideoImporter_input_Trigger&& other) noexcept;
...
#endif // Stub_VideoImporter_input_Trigger_def