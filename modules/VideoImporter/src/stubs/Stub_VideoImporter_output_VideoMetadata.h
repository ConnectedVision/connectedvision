...
// stubs/Stub_VideoImporter_output_VideoMetadata.h
...
#ifndef Stub_VideoImporter_output_VideoMetadata_def
#define Stub_VideoImporter_output_VideoMetadata_def
...
/**
 * stub class for: Class_VideoImporter_output_VideoMetadata
 * 
 * module: VideoImporter
 * description: video meta data
 */
class Stub_VideoImporter_output_VideoMetadata {

public:
	Stub_VideoImporter_output_VideoMetadata();
	Stub_VideoImporter_output_VideoMetadata(const Stub_VideoImporter_output_VideoMetadata& other);
	Stub_VideoImporter_output_VideoMetadata(const rapidjson::Value& value);
	Stub_VideoImporter_output_VideoMetadata(const std::string& str);
	virtual ~Stub_VideoImporter_output_VideoMetadata();
	Stub_VideoImporter_output_VideoMetadata &operator =(const Stub_VideoImporter_output_VideoMetadata& other);
	Stub_VideoImporter_output_VideoMetadata &operator =(Stub_VideoImporter_output_VideoMetadata&& other) noexcept;
...
#endif // Stub_VideoImporter_output_VideoMetadata_def