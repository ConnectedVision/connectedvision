...
// stubs/Stub_SyntheticVideo_params_bgColor.h
...
#ifndef Stub_SyntheticVideo_params_bgColor_def
#define Stub_SyntheticVideo_params_bgColor_def
...
/**
 * stub class for: Class_SyntheticVideo_params_bgColor
 * 
 * module: SyntheticVideo
 * description: background color
 */
class Stub_SyntheticVideo_params_bgColor {

public:
	Stub_SyntheticVideo_params_bgColor();
	Stub_SyntheticVideo_params_bgColor(const Stub_SyntheticVideo_params_bgColor& other);
	Stub_SyntheticVideo_params_bgColor(const rapidjson::Value& value);
	Stub_SyntheticVideo_params_bgColor(const std::string& str);
	virtual ~Stub_SyntheticVideo_params_bgColor();
	Stub_SyntheticVideo_params_bgColor &operator =(const Stub_SyntheticVideo_params_bgColor& other);
	Stub_SyntheticVideo_params_bgColor &operator =(Stub_SyntheticVideo_params_bgColor&& other) noexcept;
...
#endif // Stub_SyntheticVideo_params_bgColor_def