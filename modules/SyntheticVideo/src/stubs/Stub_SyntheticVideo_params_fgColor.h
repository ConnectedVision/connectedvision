...
// stubs/Stub_SyntheticVideo_params_fgColor.h
...
#ifndef Stub_SyntheticVideo_params_fgColor_def
#define Stub_SyntheticVideo_params_fgColor_def
...
/**
 * stub class for: Class_SyntheticVideo_params_fgColor
 * 
 * module: SyntheticVideo
 * description: foreground color
 */
class Stub_SyntheticVideo_params_fgColor {

public:
	Stub_SyntheticVideo_params_fgColor();
	Stub_SyntheticVideo_params_fgColor(const Stub_SyntheticVideo_params_fgColor& other);
	Stub_SyntheticVideo_params_fgColor(const rapidjson::Value& value);
	Stub_SyntheticVideo_params_fgColor(const std::string& str);
	virtual ~Stub_SyntheticVideo_params_fgColor();
	Stub_SyntheticVideo_params_fgColor &operator =(const Stub_SyntheticVideo_params_fgColor& other);
	Stub_SyntheticVideo_params_fgColor &operator =(Stub_SyntheticVideo_params_fgColor&& other) noexcept;
...
#endif // Stub_SyntheticVideo_params_fgColor_def