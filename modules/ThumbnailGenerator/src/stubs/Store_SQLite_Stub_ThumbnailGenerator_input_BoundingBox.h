...
// stubs/Store_SQLite_Stub_ThumbnailGenerator_input_BoundingBox.h
// NEVER TOUCH this file!

#ifndef Store_SQLite_Stub_ThumbnailGenerator_input_BoundingBox_def
#define Store_SQLite_Stub_ThumbnailGenerator_input_BoundingBox_def
...
// --> Do NOT EDIT <--
/**
 * stub class for: Store_SQLite_ThumbnailGenerator_input_BoundingBox
 *
 * module: Thumbnail Generator
 * description: rectangular region which is used for the cropping or for overlaying bounding boxes
 */
class Store_SQLite_Stub_ThumbnailGenerator_input_BoundingBox :
	public ConnectedVision::DataHandling::Store_SQLite_BaseClass<Class_ThumbnailGenerator_input_BoundingBox>
{
...
public:
	...
	* virtual desctructor
	*/
	virtual ~Store_SQLite_Stub_ThumbnailGenerator_input_BoundingBox();
...
public:
	...
	*/
	virtual std::vector<shared_ptr<const Class_ThumbnailGenerator_input_BoundingBox> > getBy_id(const ConnectedVision::id_t& val);
	/**
	*  Get objects filtered by configID
	*/
	virtual std::vector<shared_ptr<const Class_ThumbnailGenerator_input_BoundingBox> > getBy_configID(const ConnectedVision::id_t& val);
	/**
	*  Get objects filtered by timestamp
	*/
	virtual std::vector<shared_ptr<const Class_ThumbnailGenerator_input_BoundingBox> > getBy_timestamp(const ConnectedVision::timestamp_t& val);
#endif
...
protected:
	...
	*/
	virtual int readObject(
		...
		shared_ptr<const Class_ThumbnailGenerator_input_BoundingBox>& outObj,	///< [out] data object read from DB
	...
	*/
	virtual int writeObject(
		...
		const shared_ptr<const Class_ThumbnailGenerator_input_BoundingBox>& obj,	///< [in] data object read from DB
		sqlite3 *db,								///< [in] SQLite DB object
	...
	*/
	virtual void bind_ThumbnailGenerator_input_BoundingBox(
		sqlite3_stmt *stmt, 							///< [in/out] SQLite statement to bind with
		const boost::shared_ptr<const Class_ThumbnailGenerator_input_BoundingBox>& obj,					///< [in] data object read from DB
	...
	*/
	virtual void bind_boundingBox(
		sqlite3_stmt *stmt, 							///< [in/out] SQLite statement to bind with
		const boost::shared_ptr<const Class_ThumbnailGenerator_input_BoundingBox_boundingBox>& obj,					///< [in] data object read from DB
		const int64_t sortID	///< [in] sub array index to order sub items
	) const;
};
 ...
 */
class Store_SQLite_Factory_Stub_ThumbnailGenerator_input_BoundingBox :
	public ConnectedVision::DataHandling::IStore_ReadWrite_Factory<Class_ThumbnailGenerator_input_BoundingBox>
{
public:
	/**
	* constructor
	...
	* virtual desctuctor
	*/
	virtual ~Store_SQLite_Factory_Stub_ThumbnailGenerator_input_BoundingBox();

	/**
	* creates a new store
	*/
	virtual shared_ptr< ConnectedVision::DataHandling::IStore_ReadWrite<Class_ThumbnailGenerator_input_BoundingBox> > create(
...
#endif // Store_SQLite_Stub_ThumbnailGenerator_input_BoundingBox_def